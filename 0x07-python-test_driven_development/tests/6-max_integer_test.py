#!/usr/bin/python3
"""
testing max_integer([..]) Using UNITTEST
"""
import unittest
...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_all_neg_elements(self):
        """
        Tests all negative elements without 0
    ...
    def test_all_neg_with_0(self):
        """
        Tests all negative elements plus 0
    ...
    def test_same_elements_not_max(self):
        """
        Tests multiples that aren't max
